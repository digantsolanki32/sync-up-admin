...
const protectedRoutes = ["/"]; // Add any other routes you want to protect, e.g., '/dashboard'
...
export const config = {
    matcher: ['/', '/dashboard/:path*'], // Example: protects the homepage and all dashboard routes
};